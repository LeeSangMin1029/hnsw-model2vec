//! Unit tests for `commands::code_intel::context` helper functions.

use crate::commands::code_intel::context::bfs_forward;
use crate::commands::code_intel::{format_lines_opt as format_lines, format_lines_str_opt as format_lines_str};
