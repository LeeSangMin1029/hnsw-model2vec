...
use crate::commands::code_intel::OutputFormat;
...
pub enum Commands {
    ...
    /// Index a code folder into a new database.
    Add {
        /// Path to the database directory.
        db: PathBuf,
        /// Code folder to index.
        input: PathBuf,
        /// Directories to exclude from scanning (can be specified multiple times).
        #[arg(long)]
        exclude: Vec<String>,
    },
    /// Update an existing database with changed files.
    Update {
        /// Path to the database directory.
        db: PathBuf,
        /// Code folder to scan for changes.
        input: PathBuf,
        /// Directories to exclude from scanning (can be specified multiple times).
        #[arg(long)]
        exclude: Vec<String>,
