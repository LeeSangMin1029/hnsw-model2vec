...
pub enum GpuBackend {
    ...
    Wgpu,
    /// Pure-CPU fallback using SIMD-optimized `v_hnsw_distance`.
    Cpu,
}
...
impl GpuDistance for GpuContext {
    fn batch_l2_squared(
        ...
        match self.backend {
            ...
            GpuBackend::Cpu => Ok(distance::cpu_batch_l2_squared(
    ...
    fn is_available(&self) -> bool {
        // CPU fallback is always available; CUDA/wgpu availability is
        // determined at compile-time via feature gates.
        true
    }
